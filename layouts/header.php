...
<html>
    ...
    <body>
        <section class="nav-title">
            <div class="item1">
                <a style="background-color: black;color: white;font-size: 15px;padding: 0 10px">FAST FOOD</a>
            </div>
            
            <div class="item t1" style="margin-top: 2px;font-weight: bold;color:#fff;background-color: black;padding: 0 10px">
