            ...
            <div class="container">
                ...
                <div class="top-highlight" style="margin:-25px auto; width:80%;">
                    ...
                    <ul style="display:flex;justify-content:space-around;">
                        <li style="padding-right:50px;font-weight: bold;"><a title="Trở lại trang chủ" href="index.php"><img src="<?php base_url() ?>public/uploads/product/home1.png" alt="" width="69" height="69"></a></li>
